        ...
        <div className='row '>
            ...
            <div className='col-md-6 mt-5 pt-5 container text-center'>
               ...
               <h2 className='' style={{letterSpacing: '2px', marginRight:'10%'}} >Hello, It's Me</h2>
                ...
                <Tada><h2 className='line anim-typewriter' style={{letterSpacing: '3px', marginRight:'10%'}}><span style={{fontWeight:"bold", fontSize:'50px'}}><span style={{color:'aquamarine'}}>K</span>amon
                Ahmed</span> </h2> </Tada>
                <h4 className='text-center' style={{marginRight:'10%'}}>Junior front-end Web Developer</h4>
                <h5 className='text-center' style={{marginRight:'10%',letterSpacing: '5px'}}>“Web Design Experts! Get Instant Solution!”</h5>
